...
export default function Scene({ sentence, flavor }: SkyDiveProps) {
  ...
  useGSAP(() => {
    ...
    gsap.set(cloudsRef.current.position, { x: 10, z: 10 });
    ...
    scrollTl
      ...
      .to(cloud1Ref.current.position, { z: 7, duration: 0.5 });
  }, []);
  return (
    <group ref={groupRef}>
      {/* Can */}
      ...
      {/* <OrbitControls />. Use this for controlling and moving camera */}
...
function ThreeText({
  ...
  return words.map((word: string, wordIndex: number) => (
    <Text
      ...
      anchorX={"center"}
      anchorY={"middle"}
      characters="ABCDEFGHIJKLMNOPQERSTUVWXYZ!,.?'"
    >
      {word}
    </Text>
  ));
